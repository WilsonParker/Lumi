...
public class AddAlarmActivity extends com.graction.developer.lumi.Activity.BaseActivity {
...
//        AlarmData.AlarmItem item = alarmData.new AlarmItem(place_name, place_address, memo, selectedWeek, hourOfDay, minute);
    ...
    public void searchEvent(View view) {
        startActivityForResult(new Intent(this, com.graction.developer.lumi.Activity.SearchAddressActivity.class), DataStorage.Request.SEARCH_ADDRESS_REQUEST);
    }
